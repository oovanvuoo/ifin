...
- Name: smoke/signup.spec.ts >> C - Registration Flow >> TC-006 | Validate boundary độ dài số điện thoại tối đa
- Location: tests/smoke/signup.spec.ts:119:7
