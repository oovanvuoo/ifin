...
- Name: smoke/signup.spec.ts >> C - Registration Flow >> TC-005 | Validate boundary độ dài số điện thoại tối thiểu
- Location: tests/smoke/signup.spec.ts:105:7
