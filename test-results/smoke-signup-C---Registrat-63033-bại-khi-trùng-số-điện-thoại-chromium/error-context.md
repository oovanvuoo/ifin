...
- Name: smoke/signup.spec.ts >> C - Registration Flow >> TC-004 | Register thất bại khi trùng số điện thoại
- Location: tests/smoke/signup.spec.ts:81:7
